...
function getCoinMarket(coin, curr, days) {
  return "/coins/" + coin + "/market_chart?vs_currency=" + currency[1] + "&days="+days+"";
}
...
function getCoinHistory(coin, date) {
    return "/coins/" + coin + "/history?date=" + date;
}
